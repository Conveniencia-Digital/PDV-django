...
from colaborador.views import ListaColaborador, cadastrarcolaborador, apagarcolaborador, editarcolaborador, DetalheColaboradorView, total_colaborador, buscarvendedores
from django.contrib.auth.decorators import login_required


urlpatterns = [
    path('colaborador/', login_required(ListaColaborador.as_view()), name='colaborador'),
    path('colaborador/buscar-vendedores/', buscarvendedores, name='buscar-vendedores'),
